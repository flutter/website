...
object, you must first invoke the
[`runApp()`](https://docs.flutter.io/flutter/widgets/runApp.html) or
[`WidgetsFlutterBinding.ensureInitialized()`](https://docs.flutter.io/flutter/widgets/WidgetsFlutterBinding/ensureInitialized.html)
...
operation when the user performs a UI interaction.
   ...
   then call the [`sendJSON`](https://docs.flutter.io/flutter/services/HostMessages/sendJSON.html)
