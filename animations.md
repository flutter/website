...
[`Animation`](http://docs.flutter.io/animation/Animation-class.html)
...
[`addListener`](http://docs.flutter.io/animation/Animation/addListener.html).
Typically, a [`State`](http://docs.flutter.io/widgets/State-class.html)
object that listens to an animation will call
[`setState`](http://docs.flutter.io/widgets/State/setState.html) on
...
[`AnimatedWidget`](http://docs.flutter.io/widgets/AnimatedWidget-class.html)
and
[`AnimatedBuilder`](http://docs.flutter.io/widgets/AnimatedBuilder-class.html).
...
[`build`](http://docs.flutter.io/widgets/AnimatedWidget/build.html)
...
[`AnimationStatus`](http://docs.flutter.io/animation/AnimationStatus-class.html),
...
[`addStatusListener`](http://docs.flutter.io/animation/Animation/addStatusListener.html).
...
[`AnimationController`](http://docs.flutter.io/animation/AnimationController-class.html).
...
[`forward`](http://docs.flutter.io/animation/AnimationController/forward.html)
or [`stop`](http://docs.flutter.io/animation/AnimationController/stop.html)
the animation and later
[`resume`](http://docs.flutter.io/animation/AnimationController/resume.html)
it. You can also [`fling`](http://docs.flutter.io/animation/AnimationController/fling.html)
...
[`ReverseAnimation`](http://docs.flutter.io/animation/ReverseAnimation-class.html)
that mirrors the original animation but runs in the opposite direction (e.g.,
from 1.0 to 0.0). Similarly, you can create a
[`CurvedAnimation`](http://docs.flutter.io/animation/CurvedAnimation-class.html)
whose value is adjusted by a [curve](http://docs.flutter.io/animation/Curves-class.html).

## Tweens

To animate beyond the 0.0 to 1.0 interval, you can use a
[`Tween<T>`](http://docs.flutter.io/animation/Tween-class.html), which
interpolates between its
[`begin`](http://docs.flutter.io/animation/Tween/begin.html)
and [`end`](http://docs.flutter.io/animation/Tween/end.html)
values. Many types have specific `Tween` subclasses that provide type-specific
interpolation. For example,
[`ColorTween`](http://docs.flutter.io/animation/ColorTween-class.html)
interpolates between colors and
[`RectTween`](http://docs.flutter.io/animation/RectTween-class.html)
...
[`lerp`](http://docs.flutter.io/animation/Tween/lerp.html)
function.
...
1. You can [`evaluate`](http://docs.flutter.io/animation/Tween/evaluate.html)
...
2. You can [`animate`](http://docs.flutter.io/animation/Animatable/animate.html)
...
The
[`Scheduler`](http://docs.flutter.io/scheduler/Scheduler-class.html)
...
[`addFrameCallback()`](http://docs.flutter.io/scheduler/Scheduler/addFrameCallback.html).
...
The
[`Ticker`](http://docs.flutter.io/scheduler/Ticker-class.html)
...
The
[`Force`](http://docs.flutter.io/animation/Force-class.html)
abstract class provides a factory for `Simulation` instances.

## Animatables

The
[`Animatable`](http://docs.flutter.io/animation/Animatable-class.html)
...
The
[`Tween`](http://docs.flutter.io/animation/Tween-class.html)
...
The
[`Curve`](http://docs.flutter.io/animation/Curve-class.html)
...
([`kAlwaysCompleteAnimation`](http://docs.flutter.io/animation/kAlwaysCompleteAnimation-constant.html),
[`kAlwaysDismissedAnimation`](http://docs.flutter.io/animation/kAlwaysDismissedAnimation-constant.html),
[`AlwaysStoppedAnimation`](http://docs.flutter.io/animation/AlwaysStoppedAnimation-class.html));
