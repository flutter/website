...
[13101]({{site.github}}/flutter/engine/pull/13101) [dart_aot_runner] Generate vmservice aotsnapshots

[13103]({{site.github}}/flutter/engine/pull/13103) [dart_aot_runner] Complete the port of dart_aot_runner

[13121]({{site.github}}/flutter/engine/pull/13121) Change IO thread shader cache strategy

[13122]({{site.github}}/flutter/engine/pull/13122) refactoring chrome_installer

[13123]({{site.github}}/flutter/engine/pull/13123) Upgrades the ICU version to 64.2

[13124]({{site.github}}/flutter/engine/pull/13124) Allow embedders to specify a render task runner description.

[13125]({{site.github}}/flutter/engine/pull/13125) add the dart:__interceptors library to the dart sdk

[13126]({{site.github}}/flutter/engine/pull/13126) [frontend_server] Include bytecode generation in the training run.

[13143]({{site.github}}/flutter/engine/pull/13143) Add flutter_tester binary to the CIPD package

[13144]({{site.github}}/flutter/engine/pull/13144) Document //flutter/runtime/dart_vm

[13151]({{site.github}}/flutter/engine/pull/13151) Remove incomplete static thread safety annotations.

[13153]({{site.github}}/flutter/engine/pull/13153) Make the Dart isolate constructor private.

[13154]({{site.github}}/flutter/engine/pull/13154) Fix an output file path for the frontend server package_incremental script

[13157]({{site.github}}/flutter/engine/pull/13157) Fix type error in SkVertices

[13159]({{site.github}}/flutter/engine/pull/13159) Move surface-based SceneBuilder implementation under surface/

[13162]({{site.github}}/flutter/engine/pull/13162) Document //flutter/runtime/dart_isolate.h

[13175]({{site.github}}/flutter/engine/pull/13175) Remove redundant call to updateEditingState in sendKeyEvent

[13176]({{site.github}}/flutter/engine/pull/13176) Add repeatCount to FlutterKeyEvent

[13177]({{site.github}}/flutter/engine/pull/13177) Update compiler to Clang 10.

[13182]({{site.github}}/flutter/engine/pull/13182) If we get a 'down' event, add that device to the active devices.

[13185]({{site.github}}/flutter/engine/pull/13185) Adding firefox_installer.dart

[13192]({{site.github}}/flutter/engine/pull/13192) Use window.devicePixelRatio in the CanvasKit backend

[13193]({{site.github}}/flutter/engine/pull/13193) Custom compositor layers must take into account the device pixel ratio.

[13196]({{site.github}}/flutter/engine/pull/13196) Document //flutter/runtime/dart_snapshot.h

[13207]({{site.github}}/flutter/engine/pull/13207) Wrap the text in text editing to fix selections.

[13209]({{site.github}}/flutter/engine/pull/13209) Preserve stdout colors of subprocesses run by felt

[13212]({{site.github}}/flutter/engine/pull/13212) Add trace events around custom compositor callbacks.

[13218]({{site.github}}/flutter/engine/pull/13218) Specify a human readable reason for an error from the embedder API.

[13232]({{site.github}}/flutter/engine/pull/13232) Avoid dereferencing IO manager weak pointers on the UI thread

[13237]({{site.github}}/flutter/engine/pull/13237) Do not attempt to drain the SkiaUnrefQueue in the destructor

[13238]({{site.github}}/flutter/engine/pull/13238) Allow embedders to update preferrred locales.

[13239]({{site.github}}/flutter/engine/pull/13239) Hold a reference to the Skia unref queue in UIDartState

[13240]({{site.github}}/flutter/engine/pull/13240) Update CanvasKit to 0.7.0 and flesh out painting

[13241]({{site.github}}/flutter/engine/pull/13241) Ignore *.obj files when gathering licenses

[13242]({{site.github}}/flutter/engine/pull/13242) Update harfbuzz to 2.6.2, Roll buildroot to a518e

[13255]({{site.github}}/flutter/engine/pull/13255) Fix NPE in accessibility bridge

[13261]({{site.github}}/flutter/engine/pull/13261) Updated license script to ignore testdata directories

[13265]({{site.github}}/flutter/engine/pull/13265) Ensure we call into Engine from the UI taskrunner in Shell::EngineHasLivePorts()

[13269]({{site.github}}/flutter/engine/pull/13269) Send flag modified events to the framework

[13270]({{site.github}}/flutter/engine/pull/13270) Add recipe changelog

[13274]({{site.github}}/flutter/engine/pull/13274) Fix decode feature detection in HtmlCodec

[13275]({{site.github}}/flutter/engine/pull/13275) Flesh out the CanvasKit backend some more

[13292]({{site.github}}/flutter/engine/pull/13292) Disable flaky test ShellTest_ReportTimingsIsCalled.

[13295]({{site.github}}/flutter/engine/pull/13295) Avoid accessing the Cocoa view on the GPU or IO task runners.

[13311]({{site.github}}/flutter/engine/pull/13311) [recipe] Upload opt flutter_tester

[13314]({{site.github}}/flutter/engine/pull/13314) Guarding EAGLContext used by Flutter

[13319]({{site.github}}/flutter/engine/pull/13319) Add FlutterEngineRunsAOTCompiledDartCode to the embedder API.

[13321]({{site.github}}/flutter/engine/pull/13321) Pass LinearTextFlag to SkFont - iOS13 letter spacing

[13337]({{site.github}}/flutter/engine/pull/13337) Bump dart/language_model to 9fJQZ0TrnAGQKrEtuL3-AXbUfPzYxqpN_OBHr9P4hE4C

[13342]({{site.github}}/flutter/engine/pull/13342) Intercept SystemSound.play platform message before it's sent.

[13345]({{site.github}}/flutter/engine/pull/13345) Expose platform view ID on embedder semantics node

[13360]({{site.github}}/flutter/engine/pull/13360) Turn on RasterCache based on view hierarchy

[13361]({{site.github}}/flutter/engine/pull/13361) Expand on CanvasKit backend more

[13364]({{site.github}}/flutter/engine/pull/13364) [flutter_runner] Remove the checks for libdart profiler symbols

[13367]({{site.github}}/flutter/engine/pull/13367) Delay metal drawable acquisition till frame submission.

[13391]({{site.github}}/flutter/engine/pull/13391) Implement basic Picture.toImage via BitmapCanvas

[13395]({{site.github}}/flutter/engine/pull/13395) fix fml_unittes is not run during presubmit

[13397]({{site.github}}/flutter/engine/pull/13397) [flutter_runner] Don't build far files twice

[13401]({{site.github}}/flutter/engine/pull/13401) Reformat [BUILD.gn](http://build.gn/) files to comply with the format checker presubmit script

[13405]({{site.github}}/flutter/engine/pull/13405) Make sure root surface transformations survive resetting the matrix directly in Flow.

[13406]({{site.github}}/flutter/engine/pull/13406) Fix the dry run mode of the GN format checker script

[13407]({{site.github}}/flutter/engine/pull/13407) Kick luci

[13419]({{site.github}}/flutter/engine/pull/13419) [dart_runner] Common libs need to exist for aot runner

[13424]({{site.github}}/flutter/engine/pull/13424) Add isRunningInRobolectricTest back

[13440]({{site.github}}/flutter/engine/pull/13440) Switch to Cirrus Dockerfile as CI

[13444]({{site.github}}/flutter/engine/pull/13444) Remove usage of yaml module from CIPD script

[13448]({{site.github}}/flutter/engine/pull/13448) Duplicate the directory fd in fml::VisitFiles

[13451]({{site.github}}/flutter/engine/pull/13451) Fix mDNS for iOS13

[13460]({{site.github}}/flutter/engine/pull/13460) [dart] Makes the intl services available

[13461]({{site.github}}/flutter/engine/pull/13461) CIPD needs the directory to be relative

[13464]({{site.github}}/flutter/engine/pull/13464) [recipe] Upload sky_engine to CIPD

[13468]({{site.github}}/flutter/engine/pull/13468) Pass the automaticallyRegisterPlugins flag to the FlutterEngine constructor in FlutterActivityTest

[13478]({{site.github}}/flutter/engine/pull/13478) use check_output instead of check_call

[13479]({{site.github}}/flutter/engine/pull/13479) Print the output

[13630]({{site.github}}/flutter/engine/pull/13630) Fix bug where Enter doesn't add new line in multi-line fields

[13642]({{site.github}}/flutter/engine/pull/13642) Issues/39832 reland

[13643]({{site.github}}/flutter/engine/pull/13643) Ensure that the CAMetalLayer FBO attachments can be read from.

[13649]({{site.github}}/flutter/engine/pull/13649) Add 'Cough' test font and support multiple test fonts.

[13695]({{site.github}}/flutter/engine/pull/13695) Fix Class.forName unchecked call warning

[13697]({{site.github}}/flutter/engine/pull/13697) Moves pointer event sanitizing to engine.

[13708]({{site.github}}/flutter/engine/pull/13708) Ensure that the device pixel ratio is taken into account with window metrics in physical pixels.

[13710]({{site.github}}/flutter/engine/pull/13710) Fix picture raster cache throttling

[13711]({{site.github}}/flutter/engine/pull/13711) Imagefilter wrapper object

[13719]({{site.github}}/flutter/engine/pull/13719) Fix NPE in splash screen lookup

[13727]({{site.github}}/flutter/engine/pull/13727) Add line boundary information to LineMetrics.

[13728]({{site.github}}/flutter/engine/pull/13728) Prefer SchedulerBinding.addTimingsCallback

[13731]({{site.github}}/flutter/engine/pull/13731) Expose the platform view mutator stack to custom compositors.

[13735]({{site.github}}/flutter/engine/pull/13735) Cleanup obsolete --strong option of front-end server

[13736]({{site.github}}/flutter/engine/pull/13736) libtxt: pass an RTL bool flag instead of a bidiFlags enum to measureText

[13742]({{site.github}}/flutter/engine/pull/13742) Only specify --no-link-platform when not specifying --aot, roll dart-lang sdk

[13744]({{site.github}}/flutter/engine/pull/13744) Create a new picture recorder even when the embedder supplied render target is recycled.

[13747]({{site.github}}/flutter/engine/pull/13747) Move TextRange from the framework to dart:ui.

[13760]({{site.github}}/flutter/engine/pull/13760) Implement Path.computeMetrics in the CanvasKit backend

[13762]({{site.github}}/flutter/engine/pull/13762) Turn on RasterCache based on view hierarchy

[13765]({{site.github}}/flutter/engine/pull/13765) Change wordBoundary to take dynamic temporarily

[13768]({{site.github}}/flutter/engine/pull/13768) Add ImageFilter and BackdropFilter to CanvasKit backend

[13772]({{site.github}}/flutter/engine/pull/13772) Move Path and PathMetrics from canvas.dart into their own files. No delta

[13780]({{site.github}}/flutter/engine/pull/13780) Allow passing hot reload debugging flags through

[13781]({{site.github}}/flutter/engine/pull/13781) Create a WeakPtrFactory for use on the UI thread in VsyncWaiter

[13782]({{site.github}}/flutter/engine/pull/13782) Document the coordinate space of points in FlutterPointerEvent.

[13784]({{site.github}}/flutter/engine/pull/13784) Add Helvetica and sans-serif as fallback font families

[13785]({{site.github}}/flutter/engine/pull/13785) Fix RendererContextSwitch result check in Rasterizer::MakeRasterSnapshot

[13786]({{site.github}}/flutter/engine/pull/13786) Take devicePixelRatio into account when drawing shadows

[13795]({{site.github}}/flutter/engine/pull/13795) Adds missing comma in EngineParagraphStyle.toString()

[13796]({{site.github}}/flutter/engine/pull/13796) implement radial gradient in canvaskit backend

[13799]({{site.github}}/flutter/engine/pull/13799) Update version of dart/language_model distributed with flutter engine to latest

[13803]({{site.github}}/flutter/engine/pull/13803) [build] Make --engine-version flag optional

[13805]({{site.github}}/flutter/engine/pull/13805) Remove extra shadows from ParagraphStyle

[13812]({{site.github}}/flutter/engine/pull/13812) RendererContextSwitch guard flutter's gl context rework.

[13829]({{site.github}}/flutter/engine/pull/13829) [dart_runner] Initialize logging and tracing

[13832]({{site.github}}/flutter/engine/pull/13832) Remove unused import

[13848]({{site.github}}/flutter/engine/pull/13848) Use Skia's matchStyleCSS3 to find bundled asset typefaces matching a font style

[13850]({{site.github}}/flutter/engine/pull/13850) Fix test to account for pixel ratio transformations being framework responsibility.

[13851]({{site.github}}/flutter/engine/pull/13851) Implement the rest of ui.Path methods for CanvasKit

[13869]({{site.github}}/flutter/engine/pull/13869) Changing test runner and platform to be browser independent

[13881]({{site.github}}/flutter/engine/pull/13881) Change edge conditions of getLineBoundary

[13902]({{site.github}}/flutter/engine/pull/13902) Adding opacity -> alpha method to Color class

[13903]({{site.github}}/flutter/engine/pull/13903) Implement basic text rendering support in CanvasKit backend

[13904]({{site.github}}/flutter/engine/pull/13904) Fix withIn matcher distance function lookup

[13907]({{site.github}}/flutter/engine/pull/13907) allow ignoring toString, hashCode, and == in api_conform_test

[13908]({{site.github}}/flutter/engine/pull/13908) Made a way to turn off the OpenGL operations on the IO thread for backgrounded apps

[13918]({{site.github}}/flutter/engine/pull/13918) Add virtual destructor to GPUSurfaceSoftwareDelegate.

[13926]({{site.github}}/flutter/engine/pull/13926) Add dev_compiler and frontend_server to package uploading rule

[13934]({{site.github}}/flutter/engine/pull/13934) Ensure we use the base CompositorContext's AcquireFrame method when screenshotting

[13943]({{site.github}}/flutter/engine/pull/13943) Made the thread checker print out the thread names on Apple platforms.

[13945]({{site.github}}/flutter/engine/pull/13945) Update SwiftShader to 5d1e854.

[13962]({{site.github}}/flutter/engine/pull/13962) Added auto-reviewer config file

[13975]({{site.github}}/flutter/engine/pull/13975) Refactor to passing functions by const ref

[14082]({{site.github}}/flutter/engine/pull/14082) add pointer data santizing in flutter web engine
...
[37508]({{site.github}}/flutter/flutter/pull/37508) build bundle with assemble

[37642]({{site.github}}/flutter/flutter/pull/37642) Unit test for build.dart::GenSnapshot

[37832]({{site.github}}/flutter/flutter/pull/37832) add --exit and --match-host-platform defaults to devicelab runner

[37845]({{site.github}}/flutter/flutter/pull/37845) echo error messages to stderr

[38560]({{site.github}}/flutter/flutter/pull/38560) refactor cocoapods validator to detect broken install

[38576]({{site.github}}/flutter/flutter/pull/38576) flutter_tools/version: git log.showSignature=false

[38632]({{site.github}}/flutter/flutter/pull/38632) Flutter Plugin Tool supports multi-platform plugin config

[38654]({{site.github}}/flutter/flutter/pull/38654) [flutter_tool] Remove some async file io

[38869]({{site.github}}/flutter/flutter/pull/38869) Store file hashes per build configuration.

[38894]({{site.github}}/flutter/flutter/pull/38894) [flutter_tool] Move http request close under try-catch

[38907]({{site.github}}/flutter/flutter/pull/38907) Throw error when hot reload enters bad state

[38920]({{site.github}}/flutter/flutter/pull/38920) [flutter_tool] Handle crashes from doctor validators

[38925]({{site.github}}/flutter/flutter/pull/38925) [flutter_tool] Only send one crash report per run

[38932]({{site.github}}/flutter/flutter/pull/38932) Add build warning for non-debug desktop builds

[39000]({{site.github}}/flutter/flutter/pull/39000) Dont throw StateError when calling assemble

[39005]({{site.github}}/flutter/flutter/pull/39005) [flutter_tool] Teach crash reporter about HttpException

[39013]({{site.github}}/flutter/flutter/pull/39013) Update package versions to latest

[39052]({{site.github}}/flutter/flutter/pull/39052) Make forward calls run interactively

[39136]({{site.github}}/flutter/flutter/pull/39136) [flutter_tool] Some additional input validation for 'version'

[39140]({{site.github}}/flutter/flutter/pull/39140) Move commands into their own shard

[39147]({{site.github}}/flutter/flutter/pull/39147) Downgrade the AndroidX warning

[39274]({{site.github}}/flutter/flutter/pull/39274) Use output dir instead of specific paths in assemble rules

[39280]({{site.github}}/flutter/flutter/pull/39280) [flutter_tool] Use a timeout for xcode showBuildSettings

[39358]({{site.github}}/flutter/flutter/pull/39358) surface errors from build runner

[39445]({{site.github}}/flutter/flutter/pull/39445) [flutter_tool] Add onError callback to asyncGuard. Use it in Doctor

[39524]({{site.github}}/flutter/flutter/pull/39524) Register flutterVersion service in flutter_tools.

[39530]({{site.github}}/flutter/flutter/pull/39530) keep symbols for profile

[39541]({{site.github}}/flutter/flutter/pull/39541) Handle single unsupported device

[39555]({{site.github}}/flutter/flutter/pull/39555) Use feature flags to control build command visibility

[39558]({{site.github}}/flutter/flutter/pull/39558) Filter error message from skip build script checks

[39579]({{site.github}}/flutter/flutter/pull/39579) [flutter_tools] Add a timeout to another showBuildSettings command

[39654]({{site.github}}/flutter/flutter/pull/39654) Use persisted build information to automatically clean old outputs

[39699]({{site.github}}/flutter/flutter/pull/39699) Detecting when installing over MingW's Git Bash, fixing paths

[39781]({{site.github}}/flutter/flutter/pull/39781) Add lib/generated_plugin_registrant.dart to gitignore

[39782]({{site.github}}/flutter/flutter/pull/39782) Allow specifying a project for Xcode getInfo

[39899]({{site.github}}/flutter/flutter/pull/39899) [flutter_tool] process.dart cleanup

[39997]({{site.github}}/flutter/flutter/pull/39997) Remove visibleForTesting annotation; this constructor is used outside…

[40029]({{site.github}}/flutter/flutter/pull/40029) [BUG] Process all children of intent-filter instead of just the first one to identify default activity

[40131]({{site.github}}/flutter/flutter/pull/40131) ensure we use pub from flutter SDK

[40159]({{site.github}}/flutter/flutter/pull/40159) [flutter_tool] Kill a timing-out process before trying to drain its streams

[40171]({{site.github}}/flutter/flutter/pull/40171) Place hot reload artifacts in a temp directory

[40195]({{site.github}}/flutter/flutter/pull/40195) Make Swift plugin template swift-format compliant

[40210]({{site.github}}/flutter/flutter/pull/40210) make sure we launch with dwds

[40259]({{site.github}}/flutter/flutter/pull/40259) remove io and isolate from libraries

[40366]({{site.github}}/flutter/flutter/pull/40366) Place existing dill into hot reload temp directory to boost initialization time

[40368]({{site.github}}/flutter/flutter/pull/40368) ensure dart2js does not compile unsupported packages

[40397]({{site.github}}/flutter/flutter/pull/40397) Adds list required components when VS is not installed

[40410]({{site.github}}/flutter/flutter/pull/40410) Remove fluter tool usage of protobuf

[40435]({{site.github}}/flutter/flutter/pull/40435) [flutter_tool] Remove the synchronous -showBuildSettings

[40472]({{site.github}}/flutter/flutter/pull/40472) Dont kill other processes when starting desktop application

[40783]({{site.github}}/flutter/flutter/pull/40783) ensure debug builds are only accessible through run

[40795]({{site.github}}/flutter/flutter/pull/40795) Update toolchain description to request the latest version

[40968]({{site.github}}/flutter/flutter/pull/40968) add missing trailing commas in flutter_tools

[40988]({{site.github}}/flutter/flutter/pull/40988) [flutter_tool] Report rss high watermark in command analytics events

[41224]({{site.github}}/flutter/flutter/pull/41224) fix flutter error report correct local widget

[41304]({{site.github}}/flutter/flutter/pull/41304) [flutter_tools] Allows adding multiple signal handlers

[41401]({{site.github}}/flutter/flutter/pull/41401) Flutter build bundle without --precompiled should always perform a debug build.

[41406]({{site.github}}/flutter/flutter/pull/41406) Retry devfs uploads in case they fail.

[41424]({{site.github}}/flutter/flutter/pull/41424) Don't update last compiled time when compilation is rejected

[41447]({{site.github}}/flutter/flutter/pull/41447) Switch to assemble API for dart2js

[41493]({{site.github}}/flutter/flutter/pull/41493) [flutter_tool] Report to analytics when the tool is killed by a signal

[41514]({{site.github}}/flutter/flutter/pull/41514) Ensure we find dart.exe on local engines

[41519]({{site.github}}/flutter/flutter/pull/41519) Make desktop stopApp only apply to processes Flutter started

[41583]({{site.github}}/flutter/flutter/pull/41583) Add debugging option to write vmservice address to file after starting

[41610]({{site.github}}/flutter/flutter/pull/41610) track unused inputs in build_runner

[41621]({{site.github}}/flutter/flutter/pull/41621) change logging in mDNS discovery to verbose-mode only

[41652]({{site.github}}/flutter/flutter/pull/41652) [flutter_tools] Add more info to pub get failure event

[41687]({{site.github}}/flutter/flutter/pull/41687) Use processManager.run() instead of manually capturing streams in test_utils getPackages()

[41697]({{site.github}}/flutter/flutter/pull/41697) Handle missing .packages file in the flutter tool for prebuilt artifacts

[41735]({{site.github}}/flutter/flutter/pull/41735) handle empty entry in asset list and add more explicit validation

[41751]({{site.github}}/flutter/flutter/pull/41751) Add support for downloading x86 JIT release artifact

[41788]({{site.github}}/flutter/flutter/pull/41788) Reduce log verbosity by removing individual used files

[41832]({{site.github}}/flutter/flutter/pull/41832) Plumb --enable-asserts through to frontend_server invocation in debug…

[41862]({{site.github}}/flutter/flutter/pull/41862) Make output directory a build input

[41989]({{site.github}}/flutter/flutter/pull/41989) Flutter doctor should require java 1.8+

[42008]({{site.github}}/flutter/flutter/pull/42008) Restructure ProjectFileInvalidator.findInvalidated a bit

[42016]({{site.github}}/flutter/flutter/pull/42016) [flutter_tool] Re-work analytics events to use labels and values

[42026]({{site.github}}/flutter/flutter/pull/42026) Stop leaking iproxy processes

[42028]({{site.github}}/flutter/flutter/pull/42028) Make ProjectFileInvalidator.findInvalidated able to use the async FileStat.stat

[42187]({{site.github}}/flutter/flutter/pull/42187) Be more verbose when pub fails

[42209]({{site.github}}/flutter/flutter/pull/42209) Add error logging to flutter generate

[42243]({{site.github}}/flutter/flutter/pull/42243) Improve trailing whitespace message

[42252]({{site.github}}/flutter/flutter/pull/42252) catch argument error from Make

[42353]({{site.github}}/flutter/flutter/pull/42353) Add --cache-sksl flag to drive and run

[42354]({{site.github}}/flutter/flutter/pull/42354) Pass -Ddart.developer.causal_async_stacks=true to frontend_server invocations.

[42364]({{site.github}}/flutter/flutter/pull/42364) Wrap dwds in async guard, only catch known error types

[42373]({{site.github}}/flutter/flutter/pull/42373) Switch build commands to use process utils

[42376]({{site.github}}/flutter/flutter/pull/42376) Add option to precache unsigned mac binaries.

[42471]({{site.github}}/flutter/flutter/pull/42471) Pass build mode-specific bytecode generation options to frontend_server.

[42476]({{site.github}}/flutter/flutter/pull/42476) Refactor BuildMode into class, add jit_release configuration

[42491]({{site.github}}/flutter/flutter/pull/42491) Extra defensive programming for pub modification time assert

[42538]({{site.github}}/flutter/flutter/pull/42538) [flutter_tool] Improve yaml font map validation

[42597]({{site.github}}/flutter/flutter/pull/42597) Deflake wildcard asset test

[42655]({{site.github}}/flutter/flutter/pull/42655) resident_web_runner doesn't close debug connection

[42656]({{site.github}}/flutter/flutter/pull/42656) Catch appInstanceId error

[42668]({{site.github}}/flutter/flutter/pull/42668) dispose devices on cleanupAtFinish() for run_cold.dart

[42698]({{site.github}}/flutter/flutter/pull/42698) Ensure we stop the status when browser connection is complete

[42791]({{site.github}}/flutter/flutter/pull/42791) fix type error in manifest asset bundle

[42813]({{site.github}}/flutter/flutter/pull/42813) Fix NPE in Chrome Device

[42972]({{site.github}}/flutter/flutter/pull/42972) Do not produce an error when encountering a new type in a service response.

[42977]({{site.github}}/flutter/flutter/pull/42977) switch dart2js build to depfile, remove Source.function

[43016]({{site.github}}/flutter/flutter/pull/43016) ensure we can disable --track-widget-creation in debug mode

[43022]({{site.github}}/flutter/flutter/pull/43022) Enable dump-skp-on-shader-compilation in drive

[43042]({{site.github}}/flutter/flutter/pull/43042) add samsungexynos7570 to list of known physical devices

[43080]({{site.github}}/flutter/flutter/pull/43080) Indent Kotlin code with 4 spaces

[43180]({{site.github}}/flutter/flutter/pull/43180) Adding missing break in plugin validation check

[43217]({{site.github}}/flutter/flutter/pull/43217) [flutter_tool] Update analytics policy, send event on disable

[43219]({{site.github}}/flutter/flutter/pull/43219) Add devfs for incremental compiler JavaScript bundle

[43225]({{site.github}}/flutter/flutter/pull/43225) Catch io.StdinException from failure to set stdin echo/line mode

[43281]({{site.github}}/flutter/flutter/pull/43281) Add compiler configuration to support dartdevc target

[43292]({{site.github}}/flutter/flutter/pull/43292) initial bootstrap script for incremental compiler support

[43381]({{site.github}}/flutter/flutter/pull/43381) [flutter_tool] Use engine flutter_runner prebuilts

[43390]({{site.github}}/flutter/flutter/pull/43390) catch ChromeDebugException from dwds

[43401]({{site.github}}/flutter/flutter/pull/43401) Handle permission error during flutter clean

[43402]({{site.github}}/flutter/flutter/pull/43402) Handle format error from vswhere

[43403]({{site.github}}/flutter/flutter/pull/43403) Handle version and option skew errors

[43436]({{site.github}}/flutter/flutter/pull/43436) Handle onError callback with optional argument

[43448]({{site.github}}/flutter/flutter/pull/43448) Don't html-escape in the plugin registrant templates.

[43471]({{site.github}}/flutter/flutter/pull/43471) flip track widget creation on by default

[43544]({{site.github}}/flutter/flutter/pull/43544) Catch AppConnectionException

[43546]({{site.github}}/flutter/flutter/pull/43546) Alias upgrade-packages => update-packages

[43577]({{site.github}}/flutter/flutter/pull/43577) set trace to true for desktop builds

[43586]({{site.github}}/flutter/flutter/pull/43586) Ensure Chrome is closed on tab close

[43598]({{site.github}}/flutter/flutter/pull/43598) Catch failed daemon startup error

[43599]({{site.github}}/flutter/flutter/pull/43599) catch failure to parse FLUTTER_STORAGE_BASE_URL

[43602]({{site.github}}/flutter/flutter/pull/43602) Don't indefinitely persist file hashes, handle more error conditions

[43667]({{site.github}}/flutter/flutter/pull/43667) Added a null check for ranges in the sourceReport map.

[43725]({{site.github}}/flutter/flutter/pull/43725) Add reloadMethod RPC

[43753]({{site.github}}/flutter/flutter/pull/43753) pass --no-gen-bytecode to aot kernel compiler invocations

[43764]({{site.github}}/flutter/flutter/pull/43764) Update create.dart

[43767]({{site.github}}/flutter/flutter/pull/43767) check if libimobiledevice executables exist

[43800]({{site.github}}/flutter/flutter/pull/43800) de-flake logger test

[43862]({{site.github}}/flutter/flutter/pull/43862) Ensure target platform is passed is always passed

[43870]({{site.github}}/flutter/flutter/pull/43870) check for instanceof instead of runtimeType

[43907]({{site.github}}/flutter/flutter/pull/43907) Serve correct mime type on release dev server

[43908]({{site.github}}/flutter/flutter/pull/43908) remove no-gen-bytecode flag

[43945]({{site.github}}/flutter/flutter/pull/43945) Remove Source.behavior, fix bug in depfile invalidation

[44017]({{site.github}}/flutter/flutter/pull/44017) Asset server fix for sourcemaps

[44027]({{site.github}}/flutter/flutter/pull/44027) Allow specifying device-vmservice-port and host-vmservice-port

[44032]({{site.github}}/flutter/flutter/pull/44032) Copy chrome preferences to seeded data dir

[44052]({{site.github}}/flutter/flutter/pull/44052) Remove flutter_tool services code

[44083]({{site.github}}/flutter/flutter/pull/44083) Add --dart-define option

[44119]({{site.github}}/flutter/flutter/pull/44119) [flutter_tool] --flutter_runner will download the debug symbols

[44146]({{site.github}}/flutter/flutter/pull/44146) Remove flutter.yaml migration code

[44200]({{site.github}}/flutter/flutter/pull/44200) Make ProjectFileInvalidator injectable

[44221]({{site.github}}/flutter/flutter/pull/44221) Use platform appropriate filepaths

[44227]({{site.github}}/flutter/flutter/pull/44227) [flutter_tool] Screenshot command must require device only for _kDeviceType

[44278]({{site.github}}/flutter/flutter/pull/44278) Do not pass obsolete --strong option to front-end server

[44279]({{site.github}}/flutter/flutter/pull/44279) link platform should be true for profile

[44360]({{site.github}}/flutter/flutter/pull/44360) [flutter_tool] Stream artifact downloads to files

[44447]({{site.github}}/flutter/flutter/pull/44447) implicit-casts:false on flutter_tools/lib

[44481]({{site.github}}/flutter/flutter/pull/44481) Provide specific field to accept depfiles in target class

[44488]({{site.github}}/flutter/flutter/pull/44488) Refactorings to testbed.run and testbed.test

[44574]({{site.github}}/flutter/flutter/pull/44574) Print a message when modifying settings that you may need to reload IDE/editor

[44608]({{site.github}}/flutter/flutter/pull/44608) Reduce some direct package:archive usage

[44753]({{site.github}}/flutter/flutter/pull/44753) Always link desktop platforms

[44868]({{site.github}}/flutter/flutter/pull/44868) Catch and display version check errors during doctor

[44933]({{site.github}}/flutter/flutter/pull/44933) [flutter_tool] Don't crash when failing to delete downloaded artifacts

[44966]({{site.github}}/flutter/flutter/pull/44966) Don't log stack traces to console on build failures

[45011]({{site.github}}/flutter/flutter/pull/45011) catch IOSDeviceNotFoundError in IOSDevice.startApp()

[45153]({{site.github}}/flutter/flutter/pull/45153) implicit-casts:false on flutter_tools

[45236]({{site.github}}/flutter/flutter/pull/45236) Improve time to development by initializing frontend_server concurrently with platform build

[45239]({{site.github}}/flutter/flutter/pull/45239) implicit-casts:false in fuchsia_remote_debug_protocol

[45303]({{site.github}}/flutter/flutter/pull/45303) Allow unknown fields in pubspec plugin section

[45317]({{site.github}}/flutter/flutter/pull/45317) de-null dartDefines in daemon mode

[45319]({{site.github}}/flutter/flutter/pull/45319) catch parse error from corrupt config

[45364]({{site.github}}/flutter/flutter/pull/45364) Allow a no-op default_package key for a plugin platform

[45407]({{site.github}}/flutter/flutter/pull/45407) Don't crash if the tool cannot delete asset directory

[46011]({{site.github}}/flutter/flutter/pull/46011) [flutter_tool] Do not continue with a no-op 'upgrade'
