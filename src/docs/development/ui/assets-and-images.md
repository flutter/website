...
To add a "splash screen" to your Android Flutter application, see 
[Adding a splash screen and launch screen to an Android app](/docs/development/platform-integration/add-to-app-android/add-splash-screen).
