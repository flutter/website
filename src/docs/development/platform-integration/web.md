...
We plan to support modern browsers for both mobile and desktop. 
...
In order to test your web app on other browsers use Web server option to get a URL serving the app.
