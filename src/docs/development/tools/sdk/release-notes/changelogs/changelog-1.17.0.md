---
title: Change log for Flutter 1.17.0
short-title: change log
...
[45128](https://github.com/flutter/flutter/pull/45128) SliverOffstage (cla: yes, f: scrolling, framework, severe: new feature)
...
[45304](https://github.com/flutter/flutter/pull/45304) Re-Staged: Fixing ContinuousRectangleBorder bottom radius (cla: yes, framework, waiting for tree to go green, will affect goldens)
...
[45360](https://github.com/flutter/flutter/pull/45360) Suggest GitHub template when flutter tool crashes (a: triage, cla: yes, team, tool)
...
[45560](https://github.com/flutter/flutter/pull/45560) Always compile with isysroot on iOS to point to SDK root (cla: yes, tool)
...
[46183](https://github.com/flutter/flutter/pull/46183) fix global key error (a: tests, cla: yes, f: cupertino, f: material design, framework, severe: API break, severe: customer critical, team, waiting for tree to go green)
...
[46937](https://github.com/flutter/flutter/pull/46937) Add newlines between plugin names in GitHub template (a: triage, cla: yes, tool)
...
[48900](https://github.com/flutter/flutter/pull/48900) Do not rebuild Routes when a new opaque Route is pushed on top (cla: yes, f: cupertino, f: material design, framework, waiting for tree to go green)
...
[49376](https://github.com/flutter/flutter/pull/49376) Reland "Do not rebuild Routes when a new opaque Route is pushed on top" (cla: yes, framework, waiting for tree to go green)
...
[52332](https://github.com/flutter/flutter/pull/52332) Fix a11y scrolling for reversed lists (a: accessibility, cla: yes, customer: money (g3), f: scrolling, framework, severe: customer blocker)
...
[53105](https://github.com/flutter/flutter/pull/53105) Implement DropdownButton and DropdownButtonFormField onTap callback (cla: yes, customer: money (g3), f: material design, framework, severe: customer critical, severe: new feature, waiting for tree to go green)
...
[53118](https://github.com/flutter/flutter/pull/53118) Include metadata in GitHub crash template (a: triage, cla: yes, tool)
...
[53368](https://github.com/flutter/flutter/pull/53368) Implement DropdownMenuItem.onTap (cla: yes, customer: money (g3), f: material design, framework, severe: customer critical, severe: new feature, waiting for tree to go green)
...
[54983](https://github.com/flutter/flutter/issues/54983) Git warning of a missing default when upgrading Flutter (cp: 1.17, cp: 1.17 completed, found in release: 1.18, severe: regression, tool, ⚠ TODAY)

[54825](https://github.com/flutter/flutter/issues/54825) Multiple --dart-define cause crash during android apk build (cp: 1.17, cp: 1.17 completed, found in release: 1.17, found in release: 1.18, has reproducible steps, platform-android, tool)

[53688](https://github.com/flutter/flutter/issues/53688) New release tag format (e.g. "1.17.0-dev.0.0") not detected by flutter tool (cp: 1.17, cp: 1.17 completed, tool, ⚠ TODAY)
 

[55214](https://github.com/flutter/flutter/issues/55214) flutter symbolize is broken

[55332](https://github.com/flutter/flutter/issues/55332) [flutter_tools] When reporting Flutter version, we should explicitly favor stable tags over dev tags

[55576](https://github.com/flutter/flutter/issues/55576) Flutter upgrade should support upstream branches that have been force pushed
...
[13481](https://github.com/flutter/engine/pull/13481) Revert accidental change to MultipePlatformViewsTest (cla: yes)
...
[13647](https://github.com/flutter/engine/pull/13647) Convert images to raster on the GPU thread for Image.toByteData (cla: yes)
...
[14007](https://github.com/flutter/engine/pull/14007) Fix most fml tests on Fuchsia (affects: engine, cla: yes, code health)

[14008](https://github.com/flutter/engine/pull/14008) Don't crash but warn when the scene builder specifies no layers. (cla: yes)

[14010](https://github.com/flutter/engine/pull/14010) Remove device independent mask (cla: yes)
...
[14275](https://github.com/flutter/engine/pull/14275) Fix CGMutablePathRef memory leaks (cla: yes)
...
[14326](https://github.com/flutter/engine/pull/14326) Fixes Objective-C objects memory leaks (cla: yes)
...
[17190](https://github.com/flutter/engine/pull/17190) Felt add integration (Work in progress (WIP), cla: yes)
...
[17848](https://github.com/flutter/engine/pull/17848) update dart to 2.8.0-dev.20.10 (cla: yes)

[17931](https://github.com/flutter/engine/pull/17931) Update 1.17 engine hash to Dart 2.8.0 stable

[18089](https://github.com/flutter/engine/pull/18089) fix web_engine_integration_test_linux

[18097](https://github.com/flutter/engine/pull/18097) Video player causes iOS app to run out of memory and crash [55784](https://github.com/flutter/flutter/issues/55784)

[18066](https://github.com/flutter/engine/pull/18066) update Dart
...
[2300](https://github.com/flutter/plugins/pull/2300) [all] Switch to pedantic analysis rules (cla: yes)
...
[2304](https://github.com/flutter/plugins/pull/2304) [none] Add release process to CONTRIBUTING.md (cla: yes)
