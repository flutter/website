...
<aside class="alert alert-info" markdown="1">
  ...
  * [Internationaliation based on the `intl` package]({{site.repo-this}}/tree/master/examples/internationalization/intl_example)
</aside>
...
languages.]({{site.repo-flutter}}/tree/master/packages/flutter_localizations/lib/src/l10n)
...
[Complete source code]({{site.repo-this}}/tree/master/examples/internationalization/intl_example)
...
[an
example]({{site.repo-this}}/tree/master/examples/internationalization/minimal)
...
function generated by Dart's [intl package]({{site.pub-pkg}}/intl)
...
[Complete source code]({{site.repo-this}}/tree/master/examples/internationalization/minimal)
for this example app.
