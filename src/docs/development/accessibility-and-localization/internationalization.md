...
<aside class="alert alert-info" markdown="1">
  ...
  provided by the [intl]({{site.pub}}/packages/intl) package.
...
[intl]({{site.pub}}/packages/intl) package. [An alternative class
...
function generated by Dart's [intl package]({{site.pub}}/packages/intl)
...
[`intl`]({{site.pub}}/packages/intl) package
