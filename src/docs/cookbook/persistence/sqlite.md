...
First, insert a `Dog` into the `dogs` table. This involves two steps:
  ...
  2. Use the
  [`insert`](https://pub.dartlang.org/documentation/sqflite/latest/sqflite/DatabaseExecutor/insert.html)
...
[`update`](https://pub.dartlang.org/documentation/sqflite/latest/dart-io/FileSystemEntity/update.html)
...
[`delete`](https://pub.dartlang.org/documentation/sqflite/latest/dart-io/FileSystemEntity/delete.html)
method from the `sqflite` library. 
