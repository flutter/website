...
- Fix a crash with large text in network requests and responses -
  ...
  ![Example truncation of text in the network view]({{site.url}}/tools/devtools/release-notes/images-2.27.0/truncation.png "Example truncation of text in the network view")
