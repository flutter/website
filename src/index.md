...
<div class="homepage__illustration text-center">
    <h1 class="homepage__illustration--text">Build Beautiful Apps</h1>
</div>
...
<section class="homepage__key-points card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="homepage__key_point col-md-4">
                <h3 class="homepage__key_point_title">Fast Development</h3>
            ...
            <div class="homepage__key_point col-md-4">
                <h3 class="homepage__key_point_title">Expressive and Flexible UI</h3>
            ...
            <div class="homepage__key_point col-md-4">
                <h3 class="homepage__key_point_title">Native Performance</h3>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="https://www.youtube.com/channel/UC_x5XG1OV2P6uZZ5FSM9Ttw">Visit our YoutTube channel.</a>
            </div>
        </div>
    </div>
</section>
...
<section class="homepage__try-flutter card">
    <div class="card-body">
        <h2>Try Flutter today.</h2>
