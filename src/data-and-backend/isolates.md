...
![The main isolate diagram]({{site.url}}/assets/images/docs/development/data-and-backend/concurrency/basics-main-isolate.png)
...
![Event jank diagram]({{site.url}}/assets/images/docs/development/data-and-backend/concurrency/event-jank.png)
...
![Isolate diagram]({{site.url}}/assets/images/docs/development/data-and-backend/concurrency/isolate-bg-worker.png)
...
If you’re coming to Dart from a language with multithreading, it’s reasonable to
