...
{{site.alert.note}}
  If you'd prefer not to store your passwords in plain text,
  you can store your credentials in the [Keychain Access App][].
  In this case, skip the first 2 lines of `key.properties`
