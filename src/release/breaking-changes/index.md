...
* [Added missed `dispose()` for some disposable objects in Flutter][]
...
[Added missed `dispose()` for some disposable objects in Flutter]: {{site.url}}/release/breaking-changes/dispose
