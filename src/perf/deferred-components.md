...
1. Add Play Core to the Android app's 1build.gradle1 dependencies.
...
1. If using the Google Play Store as the
...
1. Opt into deferred components by adding
...
<a id="step-3.1"></a>
1. The `flutter build appbundle` command runs the
   validator and attempts to build the app with
...
1. Assets can also be included by adding
...
1. Manually add all deferred components
...
1. Repeat steps [3.1][] through 3.6 (this step)
