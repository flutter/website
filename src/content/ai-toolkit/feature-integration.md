...
chat history. Clicking one sends it immediately as a request to the underlying LLM.
 To set the list of suggestions,
...
[function calling example]: {{site.github}}/flutter/ai/blob/main/example/lib/function_calls/function_calls.dart
