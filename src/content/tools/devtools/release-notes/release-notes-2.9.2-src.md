...
* Take our 2022 DevTools survey! Provide your feedback and help us improve
  ...
  ![survey prompt](/assets/docs/tools/devtools/release-notes/images-2.9.2/image1.png "survey_prompt")
...
* Added frame numbers to x-axis the Flutter frames chart -
  ...
  ![frame numbers](/assets/docs/tools/devtools/release-notes/images-2.9.2/image2.png "frame_numbers")
