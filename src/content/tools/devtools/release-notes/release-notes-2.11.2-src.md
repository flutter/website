...
* Added the source line number to file uris in CPU profiles -
  ...
  ![cpu stack frame line numbers](/assets/docs/tools/devtools/release-notes/images-2.11.2/image1.png "cpu stack frame line numbers")
...
* Added support for auto-scrolling the File Explorer to the selected file -
  ...
  ![debugger file explorer scrolling](/assets/docs/tools/devtools/release-notes/images-2.11.2/image2.gif "debugger file explorer scrolling")
