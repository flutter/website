...
* Add a setting that allows users to opt in to loading DevTools
  ...
  ![Wasm opt-in setting](/assets/docs/tools/devtools/release-notes/images-2.40.2/wasm_setting.png "DevTools setting to opt into wasm.")
...
- Added a setting to the Flutter Inspector controls that
  ...
  ![New inspector opt-in setting](/assets/docs/tools/devtools/release-notes/images-2.40.2/new_inspector.png "DevTools setting to opt into the new Flutter Inspector.")
...
- Added support for validating iOS deep link settings. - [#8394](https://github.com/flutter/devtools/pull/8394)
  ...
  ![Deep link validator for iOS](/assets/docs/tools/devtools/release-notes/images-2.40.2/deep_link_ios.png "DevTools Deep link validator Page")
