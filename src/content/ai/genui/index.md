...
The GenUI SDK for Flutter helps an app developer
replace textual ("wall of text") LLM information with an
interactive, graphical UI.
It uses a JSON-based format to compose a UI from your existing
...
into your app or chatbot.
For example, instead of describing a list of products in text,
use it to render an interactive carousel of product widgets.
When a user asks to book a flight, use it to generate a
