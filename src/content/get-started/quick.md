...
The instructions on this page are configured to cover setting up Flutter on
a **Windows**{:.selected-os-text} device.
...
first install the following tools.
 ...
 1. <h3>Install Xcode command-line tools</h3>
    ...
    Download the Xcode command-line tools to
    get access to CLI tools Flutter relies on, including Git.
 ...
 1. <h3>Download and install Chrome</h3>
 ...
 1. <h3>Download and install Visual Studio Code</h3>
    ...
    To easily install Flutter, then edit and debug your apps,
...
If you'd prefer another installation method,
check out how to [Install Flutter manually][].
 ...
 1. <h3>Validate your setup</h3>
    ...
    and that Flutter can find Chrome,
    run `flutter devices` in your preferred terminal.

    You should at least see one connected device labeled **Chrome (web)**.

    If the command isn't found, or you don't see Chrome listed,
    check out [Troubleshoot Flutter install][troubleshoot].
...
<div class="card-grid link-cards">
  <div class="card filled-card list-card">
    ...
    <div class="card-content">
      <ul>
        <li>
          <a class="text-button">Write your first app</a>
        </li>
        <li>
          <a class="text-button">Learn the fundamentals</a>
        </li>
        <li>
          <a class="text-button" href="https://www.youtube.com/watch?v=b_sQ9bMltGU&list=PLjxrf2q8roU23XGwz3Km7sQZFTdB996iG">Explore Flutter widgets</a>
        </li>
        <li>
          <a class="text-button">Check out samples</a>
        </li>
        <li>
          <a class="text-button">Learn about Dart</a>
        </li>
      </ul>
    </div>
  </div>
  <div class="card filled-card list-card">
    <div class="card-leading">
      <img src="/assets/images/docs/get-started/quick/multiplatform.png" height="160" aria-hidden="true" alt="Develop for multiple platforms with Flutter">
    </div>
    <div class="card-header">
    ...
    <div class="card-content">
      <ul>
        <li>
          <a class="text-button">Develop for Android</a>
        </li>
        <li>
          <a class="text-button">Develop for iOS</a>
        </li>
        <li>
          <a class="text-button" href="/get-started/learn-flutter#apply-your-existing-knowledge">Develop for macOS</a>
        </li>
        <li>
          <a class="text-button">Develop for Windows</a>
        </li>
        <li>
          <a class="text-button">Develop for Linux</a>
        </li>
      </ul>
    </div>
  </div>
  <div class="card filled-card list-card">
    <div class="card-leading">
      <img src="/assets/images/docs/get-started/quick/up-to-date.png" height="160" aria-hidden="true" alt="Keep up to date with Flutter">
    </div>
    <div class="card-header">
    ...
    <div class="card-content">
      <ul>
        <li>
          <a class="text-button">Update Flutter</a>
        </li>
        <li>
          <a class="text-button">Check out the blog</a>
        </li>
        <li>
          <a class="text-button">Find out what's new</a>
        </li>
        <li>
          <a class="text-button">Subscribe on YouTube</a>
        </li>
        <li>
          <a class="text-button">Follow on BlueSky</a>
        </li>
      </ul>
    </div>
  </div>
