...
* Simultaneously bring up the Debug pane and run the app in the Console
  ...
  <img src="images/run-debug.png" alt="run-in-debug-mode button">

  You should see something like the following:

  <img src="images/debug-pane.png" alt="the debug pane showing that it's connected to the debugger and running the app">
