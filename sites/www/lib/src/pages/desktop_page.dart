  ...
  Component build(BuildContext context) {
    return main_([
      HeroSection(
        ...
        text: 'Build high-quality desktop apps without compromising compatibility or performance.',
        media: img(
      ...
      section(classes: 'content-container', attributes: scroll.spyContent, [
        FeatureColumnsSection([
          FeatureColumn(
            ...
            description: 'Get native-compiled performance without large browser engine dependencies.',
            image: context.asset('images/build-performant.png'),
          ),
          FeatureColumn(
            title: 'Target more users',
            description: 'Reach more users across the Windows, Mac App, and Linux Snap stores.',
            image: context.asset('images/target-more-users.svg'),
          ),
          FeatureColumn(
            title: 'Native functionality',
            description: 'Get full access to the underlying Win32, Cocoa, or UNIX platform APIs.',
          ...
          FeatureGrid(
            ...
            items: [
              FeatureGridItem(
                ...
                description: 'Flutter Folio is a multi-platform Flutter app that looks and feels great on mobile, web, and desktop devices.',
                icon: context.asset('../images/icons/see-the-samples.svg'),
                url: 'https://flutter.gskinner.com/folio/',
              ),
              FeatureGridItem(
                title: 'Watch the video',
                description: 'Learn how to build a desktop design language with Flutter through a custom widget set for desktop applications.',
              ...
              FeatureGridItem(
                ...
                description: 'Dig in and start building with more detailed resources for Flutter on desktop devices in docs.',
                icon: context.asset('../images/icons/get-started-in-docs.svg'),
                url: 'https://docs.flutter.dev/platform-integration/desktop',
              ),
              FeatureGridItem(
                title: 'Follow the roadmap',
                description: 'See where we’re going and how you can be involved. Flutter support for desktop is continually growing and evolving.',
