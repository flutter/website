...
deploy_to_firebase_staging_channel () {
    ...
    # The project ID is usually passed as an environment variable or available in the usage of firebase.
    # Using the $PROJECT_ID environment variable provided by Cloud Build.
