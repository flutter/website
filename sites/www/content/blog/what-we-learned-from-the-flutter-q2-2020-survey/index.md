...
author: jayoung-lee
image: images/1BJJb_evaKM8qgJV5VCn95Q.png
...
<DashImage figure src="images/1BJJb_evaKM8qgJV5VCn95Q.png" alt="*57% of respondents are very satisfied with Flutter. In total, 94% are positively satisfied.*" caption="*57% of respondents are very satisfied with Flutter. In total, 94% are positively satisfied.*" />
...
<DashImage figure src="images/0hllcpu-J2qiBOC-D.png" alt="*Overall, 46% of the respondents decided or convinced management to adopt Flutter after using Flutter for personal projects*" caption="*Overall, 46% of the respondents decided or convinced management to adopt Flutter after using Flutter for personal projects*" />
...
<DashImage figure src="images/0zDQJ8f84eOugD5zY.png" alt="*Stack Overflow was the common place where people found useful sample code from (26%), followed by GitHub (17%).*" caption="*Stack Overflow was the common place where people found useful sample code from (26%), followed by GitHub (17%).*" />
...
<DashImage figure src="images/0Wqiz9yZUhX2wXPl_.png" alt="*The proportion of the respondents who selected “more, but smaller code samples” remained high in all types of resources.*" caption="*The proportion of the respondents who selected “more, but smaller code samples” remained high in all types of resources.*" />
...
<DashImage figure src="images/0uWwV77z9EcebWuzx.png" alt="*Relative acceptability of Flutter apps performance, compared to Android native.*" caption="*Relative acceptability of Flutter apps performance, compared to Android native.*" />


<DashImage figure src="images/03P8YpKBYQ5APySDe.png" alt="*Relative acceptability of Flutter apps performance, compared to iOS native.*" caption="*Relative acceptability of Flutter apps performance, compared to iOS native.*" />
...
<DashImage figure src="images/05dBLaUz--b_5W2P3.png" alt="*82% of the authors published their packages because they wanted other users to benefit*" caption="*82% of the authors published their packages because they wanted other users to benefit*" />


<DashImage figure src="images/0P1coe65N82z6o0Ys.png" alt="*“Benefiting others” motivated only 58% of the authors to maintain their packages*" caption="*“Benefiting others” motivated only 58% of the authors to maintain their packages*" />
