...
The team found that the dissatisfaction feedback that was centered around lack of a stable version for web support was alleviated after the [stable release of web support](https://flutter.dev/blog/flutter-web-support-hits-the-stable-milestone) with Flutter 2.0 in March. Many of the features that we added for the stable release of the web support for Flutter were based on last year’s [survey](https://flutter.dev/blog/flutter-on-the-web-slivers-and-platform-specific-issues-user-survey-results-from-q3-2020), where we asked about the features that you might need for your web apps.

The web-specific questions in the [Q3 2020 survey](https://flutter.dev/blog/flutter-on-the-web-slivers-and-platform-specific-issues-user-survey-results-from-q3-2020) were based on the open-ended feedback we received in our Q2 survey from last year. Your comments helped us determine which areas we should prioritize for the initial stable release for Flutter’s web support.
