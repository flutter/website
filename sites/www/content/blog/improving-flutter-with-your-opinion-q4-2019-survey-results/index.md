...
author: jayoung-lee
image: images/0W4ladsI7F9pgXph1.png
...
<DashImage figure src="images/0W4ladsI7F9pgXph1.png" />
...
<DashImage figure src="images/09ldHbXX7XFfWu-op.png" alt="*Cupertino widgets have lower satisfaction rate than other Flutter subsystems*" caption="*Cupertino widgets have lower satisfaction rate than other Flutter subsystems*" />
...
<DashImage figure src="images/0j9j0D-2k7v2_NhAX.png" alt="*20% of developers are neither satisfied nor dissatisfied with Cupertino widgets*" caption="*20% of developers are neither satisfied nor dissatisfied with Cupertino widgets*" />
...
<DashImage figure src="images/0SKqIROqsnOclxsM2.png" alt="*Only 15% of respondents had experience filing GitHub issues, and 23% have upvoted for existing issues*" caption="*Only 15% of respondents had experience filing GitHub issues, and 23% have upvoted for existing issues*" />
...
<DashImage figure src="images/0k2lkGMPnru3RgKI6.png" alt="*20% of the developers have implemented CI/CD with Flutter*" caption="*20% of the developers have implemented CI/CD with Flutter*" />
...
<DashImage figure src="images/19im6A1aef_HaADS0nvMkUg.png" alt="*Satisfaction with various CI/CD services were between 60% and 74% (Note: the services with less than 150 developers are greyed out*" caption="*Satisfaction with various CI/CD services were between 60% and 74% (Note: the services with less than 150 developers are greyed out*" />
...
<DashImage figure src="images/05DO-hJz2NO5xPsMT.png" alt="*About 70% of respondents think that hot reload work as expected in &gt;90% of the cases*" caption="*About 70% of respondents think that hot reload work as expected in &gt;90% of the cases*" />


<DashImage figure src="images/0nA3zAVD8v8ArX5ai.png" alt="*20% to 27% of developers seldom or never know why hot reload doesn’t work (23% overall)*" caption="*20% to 27% of developers seldom or never know why hot reload doesn’t work (23% overall)*" />
...
<DashImage figure src="images/0BqpEt11-35wDedUr.png" alt="*17% of developers have heard about or ran into the extended grapheme clusters issue*" caption="*17% of developers have heard about or ran into the extended grapheme clusters issue*" />
...
<DashImage figure src="images/0_Eo60HUKPSvvx_p_.png" alt="*The opinion was almost an even split. To our surprise, many developers preferred the breaking change option (option 1) over the package option (option 2).*" caption="*The opinion was almost an even split. To our surprise, many developers preferred the breaking change option (option 1) over the package option (option 2).*" />
