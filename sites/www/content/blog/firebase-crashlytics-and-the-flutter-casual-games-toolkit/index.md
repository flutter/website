...
author: rich_hall
image: images/1B5i6MSUhz554dVTR484AuA.png
category: spotlight
layout: blog
---
...
<DashImage figure src="images/1B5i6MSUhz554dVTR484AuA.png" alt="Screenshots of the main FCGT screens" caption="Screenshots of the main FCGT screens" />
...
<DashImage figure src="images/1i2m8A3zAOgMPIA4LstifYg.png" alt="Disabled Ads, Games Services, and In-App Purchases code" caption="Disabled Ads, Games Services, and In-App Purchases code" />
...
<DashImage figure src="images/1LcMq0sqB0w-n-3C-Zr3V-w.png" alt="Firebase Crashlytics Dashboard" caption="Firebase Crashlytics Dashboard" />
...
<DashImage figure src="images/1dAgFBIxj5IoU17UZxc_L7Q.png" alt="main.dart: disabled Firebase Crashlytics code" caption="main.dart: disabled Firebase Crashlytics code" />
...
<DashImage figure src="images/16-qalTHst8nv6KOohptX1Q.png" alt="Game template home screen" caption="Game template home screen" />
...
<DashImage figure src="images/1JZTY90OF41GsrvE6hFAZ3g.gif" alt="FCGT “game play”" caption="FCGT “game play”" />
...
<DashImage figure src="images/1WQJfcFmwYRGKC1GO08om7g.png" alt="Output from FlutterFire config command" caption="Output from FlutterFire config command" />
...
<DashImage figure src="images/1hizJxGODTTG7ufXYp75Ryw.png" alt="Uncommented Crashlytics import statements" caption="Uncommented Crashlytics import statements" />
...
<DashImage figure src="images/1opmQwD9KqK0Nom7JTgdPiQ.png" alt="Crashlytics integration code" caption="Crashlytics integration code" />
...
<DashImage figure src="images/1ZM5_Z6YnyhZitz3OOo00SA.png" alt="Crashlytics fatal error API" caption="Crashlytics fatal error API" />
...
<DashImage figure src="images/1tQtclSgIB3HcSFOa6MYAxQ.png" alt="Before (original code)" caption="Before (original code)" />
...
<DashImage figure src="images/18MiFLAgG8cCpTtqTeX1v8Q.png" alt="Before (original code)" caption="Before (original code)" />
...
<DashImage figure src="images/1DOGxw3bdrfqppiG2ZobhIQ.png" alt="Main menu with throw exception button" caption="Main menu with throw exception button" />
...
<DashImage figure src="images/1RD1nSel5cnW4SCXyF6DgdQ.png" alt="Console output after an exception was thrown" caption="Console output after an exception was thrown" />
...
<DashImage figure src="images/1OEZMrFP7te_MknrCaSuDiw.png" alt="No events detected by Crashlytics yet" caption="No events detected by Crashlytics yet" />
...
<DashImage figure src="images/14KjDPJFvTyV_8eRVSwug5w.png" alt="Crashlytics dashboard crash-free statistics pane" caption="Crashlytics dashboard crash-free statistics pane" />


The **Issues** table of the bottom of the Crashlytics dashboard displays the thrown exceptions.

<DashImage figure src="images/1Tm7AYGZ0eWWjoCBdK0g1Nw.png" alt="Crashlytics dashboard issues table" caption="Crashlytics dashboard issues table" />
...
<DashImage figure src="images/15pbF1OIADrJvldPPBOjTYg.png" alt="Crashlytics dashboard stack trace" caption="Crashlytics dashboard stack trace" />


If you click on the **Logs** tab, you can see any messages written to the console by the `_log.severe()` method:

<DashImage figure src="images/13l-v0ElBcVHNAEwhei1ZkA.png" alt="Crashlytics dashboard logs" caption="Crashlytics dashboard logs" />
