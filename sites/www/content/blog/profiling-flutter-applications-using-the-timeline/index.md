...
author: chinmaygarde
image: images/1MBoVBDD8a68IiUpcaD3CjQ.png
category: tutorial
layout: blog
---
...
<DashImage figure src="images/1MBoVBDD8a68IiUpcaD3CjQ.png" alt="The Timeline" caption="The Timeline" />
...
<DashImage figure src="images/1ZVLNiQC-KCmz3e7t_w3LQg.png" alt="Threading in the Flutter Engine" caption="Threading in the Flutter Engine" />
...
<DashImage figure src="images/1jc6WYuRTFSJVslRi70YBHw.png" alt="Frame Pipeline" caption="Frame Pipeline" />
...
<DashImage figure src="images/1iDRQWjq4Y_mWd4Diyd67jQ.png" alt="Janky Frame (due to shader compilation)" caption="Janky Frame (due to shader compilation)" />
...
<DashImage figure src="images/1wA1fIv94nkn0LnY5OJ3IXg.png" alt="Observatory from the IDE" caption="Observatory from the IDE" />
...
<DashImage figure src="images/1ntk5Tcf1yuOhmHDlE8Zjig.png" alt="The Observatory Homepage" caption="The Observatory Homepage" />


You will now see an empty timeline. Trace are assigned categories, and, by default, no categories are enabled.

<DashImage figure src="images/1TlX5df1vv352ypRRfveEAA.png" alt="An Empty Timeline" caption="An Empty Timeline" />
...
<DashImage figure src="images/1kS5PXfU-kAN-NgwijJFQ7w.png" alt="Timeline with Streams Enabled" caption="Timeline with Streams Enabled" />
...
<DashImage figure src="images/1tNI6e9KnMvxqSyJGqGA-gQ.png" alt="A Freshly Collected Trace (enable Flow & VSync events)" caption="A Freshly Collected Trace (enable Flow & VSync events)" />
...
<DashImage figure src="images/1jSbyYB6C2wBoP5x_3FNGtA.png" alt="The Selection Pane (Easy to miss, so just use the shortcuts)" caption="The Selection Pane (Easy to miss, so just use the shortcuts)" />
...
<DashImage figure src="images/1YxI3oc-2oOSmCB0U5_Q2HA.png" alt="Duration Events & Summary" caption="Duration Events & Summary" />
...
<DashImage figure src="images/1iok8mEWRxvbqaZa_8dF9qQ.png" alt="The Event Summary" caption="The Event Summary" />
...
<DashImage figure src="images/1bEv-aW0gogJaxlpTDysf3Q.png" alt="Analyzing Repeating Events" caption="Analyzing Repeating Events" />
...
<DashImage figure src="images/1FcYP_acRHIIHKbGaAyM-9w.png" alt="Repeating Event Summary" caption="Repeating Event Summary" />
...
<DashImage figure src="images/1-8wNvN-zrrEQlIZZKT5s_A.png" alt="Flow Events for Pipeline Items" caption="Flow Events for Pipeline Items" />
...
<DashImage figure src="images/1MKXFenx4GEY1_JxHsdaSjQ.png" alt="The Sampling Profiler" caption="The Sampling Profiler" />
