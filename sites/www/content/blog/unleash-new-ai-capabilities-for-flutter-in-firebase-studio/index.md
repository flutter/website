...
author: antfitch
image: images/1lPy6kRkj2N5ybEhHIKjbVw.gif
category: spotlight
layout: blog
---
...
<DashImage figure src="images/1lPy6kRkj2N5ybEhHIKjbVw.gif" alt="The Flutter template in Firebase Studio has been upgraded for an AI-first experience" caption="The Flutter template in Firebase Studio has been upgraded for an AI-first experience" />
...
<DashImage figure src="images/1i5KGoCCzGQXV5SuTYhbpbw.gif" alt="Agent (Auto-run) mode with a Flutter project in Firebase Studio" caption="Agent (Auto-run) mode with a Flutter project in Firebase Studio" />
...
<DashImage figure src="images/1FPNH3GWzShcGYInVxc30qA.gif" alt="Overview of the default Flutter AI rules (airules.md) in Firebase Studio" caption="Overview of the default Flutter AI rules (airules.md) in Firebase Studio" />
...
<DashImage figure src="images/0CHTpeFMydBD0KQY9.png" alt="Dart MCP Server configuration for a Flutter app in Firebase Studio" caption="Dart MCP Server configuration for a Flutter app in Firebase Studio" />
