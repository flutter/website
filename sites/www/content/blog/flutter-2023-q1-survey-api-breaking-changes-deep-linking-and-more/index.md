...
author: jayoung-lee
image: images/0BujM3j2SMg1qp3hi.png
...
<DashImage figure src="images/0EvfHfmRcMbEyHcAh.png" alt="*42% said that Flutter’s growth is very fast and 38% said that it is somewhat fast*" caption="*42% said that Flutter’s growth is very fast and 38% said that it is somewhat fast*" />
...
<DashImage figure src="images/0zeJT-J_oHhKYFcem.png" alt="*Reasons to think the Flutter’s recent growth is fast or slow*" caption="*Reasons to think the Flutter’s recent growth is fast or slow*" />
...
<DashImage figure src="images/0BujM3j2SMg1qp3hi.png" alt="*51% of the developers have experienced breaking changes in the last 12 months*" caption="*51% of the developers have experienced breaking changes in the last 12 months*" />
...
<DashImage figure src="images/0YjPyKLHdN6xW-4-3.png" alt="*Perception around breaking changes*" caption="*Perception around breaking changes*" />
...
<DashImage figure src="images/0LreVRDXghbLuzKDR.png" alt="*Ratings on the Flutter team’s handling of breaking changes*" caption="*Ratings on the Flutter team’s handling of breaking changes*" />
...
<DashImage figure src="images/0dQYszaV1ZKzV_b-y.png" alt="*Percentage of developers who implemented deep links in Android and iOS apps*" caption="*Percentage of developers who implemented deep links in Android and iOS apps*" />
...
<DashImage figure src="images/0GfXUuto3tB79I47F.png" />


<DashImage figure src="images/0q-OVlB4QmxOfjfOM.png" alt="What developers use to guide users from their websites to an iOS or Android app" caption="What developers use to guide users from their websites to an iOS or Android app" />
...
<DashImage figure src="images/06ZkWSeMzkU_vy8uJ.png" alt="What developers use to route users within an app" caption="What developers use to route users within an app" />
