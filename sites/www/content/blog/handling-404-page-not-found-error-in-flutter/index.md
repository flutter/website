...
description: >-
  Learn how to handle 404 errors and create a custom page not found error page
...
To learn more about routes in Flutter, see the Medium post [“Navigating URLs using named routes”](https://flutter.dev/blog/flutter-web-navigating-urls-using-named-routes).
