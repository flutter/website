...
The way we consume the news has changed considerably over the last twenty years. Market research suggests that [US smartphone users spend 88% of their time using apps versus mobile web browsers](https://www.insiderintelligence.com/content/the-majority-of-americans-mobile-time-spent-takes-place-in-apps). However, for news publishers that are often resource-constrained, mobile apps can be difficult and costly to build.
