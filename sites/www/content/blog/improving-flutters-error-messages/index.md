...
author: taodong
image: images/1l8l2xWisc5Mtc6xzFaucmg.png
...
<DashImage figure src="images/1l8l2xWisc5Mtc6xzFaucmg.png" alt="An example of the new structured error message" caption="An example of the new structured error message" />
...
<DashImage figure src="images/1l8nn2JJ5rSQqfW2col87NQ.png" alt="The original message for the same RenderFlex Overflow error" caption="The original message for the same RenderFlex Overflow error" />
...
<DashImage figure src="images/0X_nD364tctKThHvy.png" alt="A question posted to StackOverflow about the “No Material widget found” error" caption="A question posted to StackOverflow about the “No Material widget found” error" />
...
<DashImage figure src="images/1Vz1dqvpOYqnFOIEVIZuVww.png" alt="The colors variant of the message for the “Missing Material” error" caption="The colors variant of the message for the “Missing Material” error" />
...
<DashImage figure src="images/0uct3j7acy9KVMqi2.png" alt="The spaces variant of the message for the “Missing Material” error" caption="The spaces variant of the message for the “Missing Material” error" />
...
<DashImage figure src="images/1FHiGbc69QAdOuRGDezhc1A.png" alt="The ellipses variant of the message for the “Missing Material” error" caption="The ellipses variant of the message for the “Missing Material” error" />
...
<DashImage figure src="images/0_b3-Pr2bUFSsbAUM.png" alt="Error comprehension rates across four message variants" caption="Error comprehension rates across four message variants" />
...
<DashImage figure src="images/0evHu5BfK5pfBSCz3.png" alt="Error fix rates across four message variants" caption="Error fix rates across four message variants" />
