---
title: SNCF Connect
description: SNCF Connect is the all-in-one mobility service, designed and developed by SNCF Connect & Tech. With more than 1.3 billion visits in 2023, SNCF Connect enables travelers to manage their journeys end to end, including buying tickets, searching itineraries, or checking traffic information in France.
headline: SNCF Connect
summary: SNCF Connect prepares for French summer sports events with Flutter
appName: SNCF Connect
companyName: SNCF Connect
logo: images/third_party/case_studies/sncf-connect/logo.png
card: images/third_party/case_studies/sncf-connect/case_study_card.png
poster: images/third_party/case_studies/sncf-connect/case_study_poster.png
locations:
  - Europe
platforms:
  - Mobile
...
<Image src="images/third_party/case_studies/sncf-connect/case_study_body_1.png" format="fullwidth" alt="" />
