...
|:---|:---|
| [**Dataset**](#dataset-tasks) | Real-world development tasks derived from critical user journeys (CUJs). |
| [**Test matrix**](#evaluation-test-matrix) | Multidimensional testing framework across models, agents, tooling configurations, and SDK versions. |
| [**Scoring system**](#scoring-architecture) | Unified grading approach evaluating functional outcomes, code quality, and developer experience, paired with diagnostic telemetry. |
| [**Harness**](#evaluation-harness) | Containerized automation infrastructure that executes evaluations at scale. |
