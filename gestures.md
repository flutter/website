...
- [`PointerDownEvent`](http://docs.flutter.io/gestures/PointerDownEvent-class.html)
  The pointer has contacted the screen at a particular location.
- [`PointerMoveEvent`](http://docs.flutter.io/gestures/PointerMoveEvent-class.html)
  The pointer has moved from one location on the screen to another.
- [`PointerUpEvent`](http://docs.flutter.io/gestures/PointerUpEvent-class.html)
  The pointer has stopped contacting the screen.
- [`PointerCancelEvent`](http://docs.flutter.io/gestures/PointerCancelEvent-class.html)
...
[`GestureDetector`](http://docs.flutter.io/widgets/GestureDetector-class.html)
