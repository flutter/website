...
[`runApp`](http://docs.flutter.io/material/runApp.html) function
with a widget:
...
The [`runApp`](http://docs.flutter.io/material/runApp.html) function
takes the given
[`Widget`](http://docs.flutter.io/material/Widget-class.html) and
makes it the root of the widget tree. In this example, the widget tree consists
of two widgets, the
[`Center`](http://docs.flutter.io/material/Center-class.html) widget
and its child, the
[`Text`](http://docs.flutter.io/material/Text-class.html) widget.
...
either
[`StatelessWidget`](http://docs.flutter.io/material/StatelessWidget-class.html)
or
[`StatefulWidget`](http://docs.flutter.io/material/StatefulWidget-class.html),
depending on whether your widget manages any state. A widget's main job is
to implement a
[`build`](http://docs.flutter.io/material/StatelessWidget/build.html)
 ...
 * [`Text`](http://docs.flutter.io/material/Text-class.html): The
   [`Text`](http://docs.flutter.io/material/Text-class.html) widget
   lets you create a run of styled text within your application.

 * [`Row`](http://docs.flutter.io/material/Row-class.html),
   [`Column`](http://docs.flutter.io/material/Column-class.html):
   These flex widgets let you create flexible layouts in both the horizontal
   ([`Row`](http://docs.flutter.io/material/Row-class.html)) and
   vertical
   ([`Column`](http://docs.flutter.io/material/Column-class.html))
   directions. Its design is based on the web's flexbox layout model.

 * [`Stack`](http://docs.flutter.io/material/Stack-class.html):
   Instead of being linearly oriented (either horizontally or vertically), a [`Stack`](http://docs.flutter.io/material/Stack-class.html)
   widget lets you stack widgets on top of each other in paint order. You can
   then use the
   [`Positioned`](http://docs.flutter.io/material/Positioned-class.html)
   widget on children of a
   [`Stack`](http://docs.flutter.io/material/Stack-class.html) to
 ...
 * [`Container`](http://docs.flutter.io/material/Container-class.html):
   The [`Container`](http://docs.flutter.io/material/Container-class.html)
   widget lets you create rectangular visual element. A container can be
   decorated with a
   [`BoxDecoration`](http://docs.flutter.io/material/BoxDecoration-class.html),
...
[`Row`](http://docs.flutter.io/material/Row-class.html) layout to
organize its children. The middle child, the `title` widget, is marked as
[`Flexible`](http://docs.flutter.io/material/Flexible-class.html),
...
the
[`flex`](http://docs.flutter.io/material/Flexible-class.html#flex)
argument to
[`Flexible`](http://docs.flutter.io/material/Flexible-class.html).
...
[`Text`](http://docs.flutter.io/material/Text-class.html) widget to
...
[`Flexible`](http://docs.flutter.io/material/Flexible-class.html) to
...
including a
[`Navigator`](http://docs.flutter.io/material/Navigator-class.html),
...
[`AppBar`](http://docs.flutter.io/material/AppBar-class.html) and
[`Scaffold`](http://docs.flutter.io/material/Scaffold-class.html)
...
[`AppBar`](http://docs.flutter.io/material/AppBar-class.html)
widget lets us pass in widgets for the
[`leading`](http://docs.flutter.io/material/AppBar-class.html#leading)
and the
[`actions`](http://docs.flutter.io/material/AppBar-class.html#actions)
of the
[`title`](http://docs.flutter.io/material/AppBar-class.html#title)
...
The
[`GestureDetector`](http://docs.flutter.io/material/GestureDetector-class.html)
...
[`GestureDetector`](http://docs.flutter.io/material/GestureDetector-class.html)
will call its
[`onTap`](http://docs.flutter.io/material/GestureDetector-class.html#onTap)
...
[`IconButton`](http://docs.flutter.io/material/IconButton-class.html),
[`RaisedButton`](http://docs.flutter.io/material/RaisedButton-class.html),
and
[`FloatingActionButton`](http://docs.flutter.io/material/FloatingActionButton-class.html)
widgets have
[`onPressed`](http://docs.flutter.io/material/RaisedButton-class.html#onPressed)
...
[`build()`](http://docs.flutter.io/material/State/build.html),
...
[`runApp`](http://docs.flutter.io/material/runApp.html) persists for
...
[`createState`](http://docs.flutter.io/material/StatefulWidget-class.html#createState)
...
[`State`](http://docs.flutter.io/material/State-class.html) with
...
use its
[`config`](http://docs.flutter.io/material/State-class.html#config)
...
[`didUpdateConfig`](http://docs.flutter.io/material/State-class.html#didUpdateConfig)
...
in a
[`setState`](http://docs.flutter.io/material/State-class.html#setState)
call. Calling
[`setState`](http://docs.flutter.io/material/State-class.html#setState)
...
tree and then calls
[`initState`](http://docs.flutter.io/material/State-class.html#initState)
on the state object. A subclass of
[`State`](http://docs.flutter.io/material/State-class.html) can
override
[`initState`](http://docs.flutter.io/material/State-class.html#initState)
...
[`super.initState`](http://docs.flutter.io/material/State-class.html#initState).

When a state object is no longer needed, the framework calls
[`dispose`](http://docs.flutter.io/material/State-class.html#dispose)
...
[`super.dispose`](http://docs.flutter.io/material/State-class.html#dispose).
...
[`runtimeType`](http://docs.flutter.io/material/Widget-class.html#runtimeType)
and the order in which they appear. With keys, the framework requires that the
two widgets have the same
[`key`](http://docs.flutter.io/material/Widget-class.html#key) as
well as the same
[`runtimeType`](http://docs.flutter.io/material/Widget-class.html#runtimeType).
...
[`Input`](http://docs.flutter.io/material/Input-class.html) require
global keys because they can hold focus, which means they receive any text the
user enters into the app. The
[`Focus`](http://docs.flutter.io/material/Focus-class.html) widget
keeps track of which
[`InputState`](http://docs.flutter.io/material/InputState-class.html)
object is focused by remembering its
[`GlobalKey`](http://docs.flutter.io/material/GlobalKey-class.html).
That way the same
[`Input`](http://docs.flutter.io/material/Input-class.html) widget
