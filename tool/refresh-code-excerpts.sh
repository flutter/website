...
# Temporarily commenting out this ellipsis replacement. Don't believe it's being used,
# it's inadvertently replacing code like: TextOverflow.ellipsis -> TextOverflow....
