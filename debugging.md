...
[`debugDumpApp()`](http://docs.flutter.io/widgets/debugDumpApp.html).
...
[`InkFeatures`](http://docs.flutter.io/material/InkFeatures-class.html)
is an implementation detail of the
[`Material`](http://docs.flutter.io/material/Material-class.html)
widget.

Since the `debugDumpApp()` call is invoked when the button changes
from being pressed to being released, it coincides with the
[`FlatButton`](http://docs.flutter.io/material/FlatButton-class.html)
object calling
[`setState()`](http://docs.flutter.io/widgets/State/setState.html)
...
[`debugFillDescription()`](http://docs.flutter.io/material/Widget/debugFillDescription.html).
...
[`debugDumpRenderTree()`](http://docs.flutter.io/rendering/debugDumpRenderTree.html).
...
from a [frame
callback](http://docs.flutter.io/scheduler/Scheduler/addPersistentFrameCallback.html)
...
[`RenderPositionedBox`](http://docs.flutter.io/rendering/RenderPositionedBox-class.html)
...
[`Center`](http://docs.flutter.io/widgets/Center-class.html)
...
[`RenderPadding`](http://docs.flutter.io/rendering/RenderPadding-class.html),
further inserts these constraints to ensure there is room for the
padding, and thus the
[`RenderConstrainedBox`](http://docs.flutter.io/rendering/RenderConstrainedBox-class.html)
...
[`FlatButton`](http://docs.flutter.io/material/FlatButton-class.html)'s
...
[`RenderParagraph`](http://docs.flutter.io/rendering/RenderParagraph-class.html)
...
dump by overriding
[`debugDescribeSettings()`](http://docs.flutter.io/rendering/RenderObject/debugDescribeSettings.html).
Add strings to the method's argument, and call the superclass method.

### Layers

If you are trying to debug a compositing issue, you can use
[`debugDumpLayerTree()`](http://docs.flutter.io/rendering/debugDumpLayerTree.html).
...
[`debugDumpSemanticsTree()`](http://docs.flutter.io/rendering/debugDumpSemanticsTree.html).
...
[`debugPaintSizeEnabled`](http://docs.flutter.io/rendering/debugPaintSizeEnabled.html)
...
The
[`debugPaintBaselinesEnabled`](http://docs.flutter.io/rendering/debugPaintBaselinesEnabled.html)
...
The
[`debugPaintPointersEnabled`](http://docs.flutter.io/rendering/debugPaintPointersEnabled.html)
...
[`debugPaintLayerBordersEnabled`](http://docs.flutter.io/rendering/debugPaintLayerBordersEnabled.html)
flag, which outlines each layer's bounds in orange, or the
[`debugRepaintRainbowEnabled`](http://docs.flutter.io/rendering/debugRepaintRainbowEnabled.html)
...
that, set the
[`timeDilation`](http://docs.flutter.io/scheduler/timeDilation.html)
...
set the
[`debugPrintMarkNeedsLayoutStacks`](http://docs.flutter.io/rendering/debugPrintMarkNeedsLayoutStacks.html)
and
[`debugPrintMarkNeedsPaintStacks`](http://docs.flutter.io/rendering/debugPrintMarkNeedsPaintStacks.html)
...
[`MaterialApp`](http://docs.flutter.io/material/MaterialApp/MaterialApp.html)
...
created by calling
[`new PerformanceOverlay.allEnabled()`](http://docs.flutter.io/widgets/PerformanceOverlay/PerformanceOverlay.allEnabled.html).)
...
[`MaterialApp`
constructor](http://docs.flutter.io/material/MaterialApp/MaterialApp.html)
...
the
[`GridPaper`](http://docs.flutter.io/widgets/GridPaper-class.html)
widget directly.
